    ...
    education: [
      {
        ...
        degree: 'Doctorate of Civil Engineering',
        institution: 'University of Auckland',
        specialization: 'Construction Project Management',
        note: 'Recipient: University of Auckland Doctoral Scholarship',
      },
      {
        period: 'Dec 2013 - Sep 2016',
        degree: 'Bachelor of Science (Hons)',
        institution: 'University of Reading',
        specialization: 'Quantity Surveying',
        note: 'Undertaken as Top-Up to the HND Qualification to meet Academic Teaching career requirements in the future',
      },
      {
        ...
        note: 'Achieved Grade: Distinction with a CGPA 3.97/4.00 Overall Best Graduating Student 2008',
      },
      {
        period: 'Jan 1997 - Dec 2001',
        degree: 'Higher National Diploma',
        institution: 'Ondo State Polytechnic, Owo',
        specialization: 'Quantity Surveying',
        note: 'Achieved Grade: Higher Credit',
      },
      {
        period: 'Jan 2003 - Sep 2003',
        degree: 'Diploma in Data Processing',
        institution: 'Ika Computer Technology, Katsina',
        note: 'Achieved Grade: Higher Credit',
      },
    ],
...
export function getTeamProfile(slug: string): TeamMemberProfile | null {
  return teamProfiles[slug] ?? null;
}
